...
public enum ErrorCode {
	...
	BASEURL_NOT_FOUND(HttpStatus.BAD_REQUEST, "BASEURL NOT FOUND"),
	DTO_HAS_NO_RELATION(HttpStatus.BAD_REQUEST, "DTO HAS NO RELATION"),
	USER_ACCESS_UNAUTHORIZED_RESOURCE(HttpStatus.BAD_REQUEST, "USER ACCESS UNAUTHORIZED RESOURCE");
